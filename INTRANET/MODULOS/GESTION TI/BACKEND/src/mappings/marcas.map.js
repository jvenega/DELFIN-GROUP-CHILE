...
function buildListParams() {
  return [
    ...
    { name: "ID_Marca", type: sql.Int, value: null },
    { name: "Glosa_Marca", type: sql.VarChar(150), value: null },
  ];
}
...
function buildCreateParams(req) {
  return [
    ...
    { name: "ID_Marca", type: sql.Int, value: null },
    { name: "Glosa_Marca", type: sql.VarChar(150), value: req.body.glosa },
  ];
}
...
function buildUpdateParams(req) {
  return [
    ...
    { name: "ID_Marca", type: sql.Int, value: parseInt(req.params.id, 10) },
    { name: "Glosa_Marca", type: sql.VarChar(150), value: req.body.glosa },
  ];
}
